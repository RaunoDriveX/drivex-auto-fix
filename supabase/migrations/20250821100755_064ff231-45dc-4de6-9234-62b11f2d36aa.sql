-- Insert mock appointment data for insurer dashboard scenarios (with correct status values)
...
-- Scenario 2: Job flagged for fraud risk due to VIN mismatch (pending review)
(
  'Michael Rodriguez',
...
-- Scenario 4: Replacement job with OEM parts requirement (confirmed and in progress)
(
  'Robert Williams',
  'rwilliams@email.com',
  '+1-555-0321',
