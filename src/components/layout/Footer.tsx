    ...
    <footer className="bg-muted/30 border-t border-border">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Company Info */}
          <div>
            <div className="text-2xl font-bold text-primary mb-4">DriveX</div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="mailto:fleet@drivex.com" className="text-muted-foreground hover:text-foreground transition-colors">Contact Us</a></li>
            </ul>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="text-sm text-muted-foreground">
              © {currentYear} DriveX. All rights reserved. Patent pending technology.
            </div>
